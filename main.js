...
var $author$project$Main$Impressum = {$: 'Impressum'};
...
var $author$project$Main$onUrlChange = function (u) {
	return $author$project$Main$Page(
		$author$project$Main$toRoute(u));
};
var $author$project$Main$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Main$onUrlRequest = function (r) {
	return $author$project$Main$LinkClicked(r);
};
...
var $author$project$Main$jet = A3($mdgriffith$elm_ui$Element$rgb255, 51, 51, 47);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('MDPDev'),
...
var $author$project$Main$powderblue = A3($mdgriffith$elm_ui$Element$rgb255, 181, 227, 216);
...
var $author$project$Main$wheat = A3($mdgriffith$elm_ui$Element$rgb255, 239, 219, 178);
var $author$project$Main$article = function (_v0) {
	var a = _v0.a;
	return A2(
		$mdgriffith$elm_ui$Element$textColumn,
		_List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$Border$glow, $author$project$Main$powderblue, 1.2),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$jet),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($mdgriffith$elm_ui$Element$Font$glow, $author$project$Main$wheat, 2.6)
						]),
...
var $author$project$Main$teasedArticle = F2(
	function (i, _v0) {
		var a = _v0.a;
		return A2(
			$mdgriffith$elm_ui$Element$column,
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$color($author$project$Main$powderblue),
							A2($mdgriffith$elm_ui$Element$Font$glow, $author$project$Main$powderblue, 2.6)
						]),
					{
...
var $author$project$Main$boxes = A2($elm$core$List$indexedMap, $author$project$Main$teasedArticle, $author$project$Main$articles);
...
var $author$project$Main$carousel = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
	...
	$mdgriffith$elm_ui$Element$html(
		A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('carousel-wrapper')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('carousel-container')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('image-one')
										]),
									_List_Nil),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('image-two')
										]),
									_List_Nil),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('image-three')
										]),
									_List_Nil)
								]))
						]))
...
var $ohanhi$lorem$Lorem$sentence = function (n) {
	return A2(
		$elm$core$String$join,
		' ',
		$ohanhi$lorem$Lorem$words(n));
};
var $author$project$Main$top = F2(
	function (h, m) {
		return A2(
			$mdgriffith$elm_ui$Element$textColumn,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$ohanhi$lorem$Lorem$sentence(120))
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(
							$ohanhi$lorem$Lorem$sentence(80))
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(
							$ohanhi$lorem$Lorem$sentence(40))
						]))
				]));
	});
...
var $author$project$Main$content = function (m) {
	var _v0 = m.route;
	switch (_v0.$) {
		case 'Home':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color($author$project$Main$wheat),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					...
					_List_fromArray(
						[
							A2($author$project$Main$top, 'Prewit', m)
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
		...
		case 'About':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Main$top, 'About', m)
						]))
				]);
		case 'Impressum':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Main$top, 'Impressum', m)
						]))
				]);
		case 'Contact':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Main$top, 'Contact', m)
						]))
				]);
		case 'Post':
			var i = _v0.a;
			var arr = $elm$core$Array$fromList($author$project$Main$articles);
			var ma = A2($elm$core$Array$get, i, arr);
			if (ma.$ === 'Just') {
				var a = ma.a;
				return _List_fromArray(
					[
						$author$project$Main$article(a)
					]);
			} else {
				return _List_Nil;
			}
...
var $akoppela$elm_logo$ElmLogo$element = A2($elm$core$Basics$composeR, $akoppela$elm_logo$ElmLogo$html, $mdgriffith$elm_ui$Element$html);
var $author$project$Main$footer = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$akoppela$elm_logo$ElmLogo$element(64)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
						...
						$mdgriffith$elm_ui$Element$text('Powered by Elm'))
					]))
			]));
};
var $author$project$Main$vanilla = A3($mdgriffith$elm_ui$Element$rgb255, 220, 191, 166);
var $author$project$Main$site = function (m) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color($author$project$Main$vanilla),
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$alignBottom,
								$mdgriffith$elm_ui$Element$centerX,
								$mdgriffith$elm_ui$Element$height(
...
var $author$project$Main$body = function (m) {
	return _List_fromArray(
		[
			...
			$author$project$Main$site(m))
		]);
};
var $author$project$Main$view = function (m) {
	return {
		body: $author$project$Main$body(m),
		title: 'Hallo Elm'
	};
};
